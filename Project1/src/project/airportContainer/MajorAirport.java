...
public class MajorAirport extends Airport {
	 ...
	 * 
	 * departure fee = operationFee * weightRatio * fullnessCoefficient * 0.9
	 * 
	 ...
	 * landing fee = operationFee * weightRatio * fullnessCoefficient * 1.0
	 * 
	 * I also modified numberOfAircrafts in Airport.
	 * 		
	...
	public double landAircraft(Aircraft aircraft) {
		...
		double landingFee = operationFee * aircraftWeightRatio * fullnessCoefficient * 1.0;
