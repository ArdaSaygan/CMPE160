...
public class FirstClassPassenger extends Passenger {
	...
	public FirstClassPassenger(long ID, double weight, int baggageCount, ArrayList<Long> destinations, Airport firstAirport) {
	...
	/**
	 * Passenger Multiplier for FirstClass = 3.2
	 * 
	 * Multiply:
